...
class CNN3D(nn.Module):
    def __init__(self, t_dim, img_x, img_y, drop_p, fc_hidden1, fc_hidden2, num_classes):
...
# CNN for encoder(CRNN) - trained from scratch
...
#Pretrained Resnet-152 for encoder
